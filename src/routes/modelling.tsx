...
const gallery = [
  { src: '/images/modelling/IMG_1809.jpg', photographer: 'Dom', handle: '@dmwphotopro' },
  { src: '/images/modelling/coat.jpg', photographer: 'Dom', handle: '@dmwphotopro' },
  { src: '/images/modelling/walk.png', photographer: 'Dom', handle: '@dmwphotopro' },
  ...
  { src: '/images/modelling/suit.png', photographer: 'Dom', handle: '@dmwphotopro' },
  ...
  { src: '/images/modelling/water.png', photographer: 'Dom', handle: '@dmwphotopro' },
    ...
    <div className="max-w-7xl mx-auto px-4 py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20 items-start">
        ...
        <div className="rounded-2xl overflow-hidden border border-white/5 aspect-video">
          <iframe
            src="https://www.youtube.com/embed/eVlaEaThBo8?si=Pgke014wIzW1MOXz" 
            title="Demo Reel"
